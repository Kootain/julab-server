  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Scanner#createMany
         * @methodOf lbServices.Scanner
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Scanner#createChangeStream
         * @methodOf lbServices.Scanner
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Scanners/change-stream",
          method: "POST"
        },
      }
    );
    ...
    /**
    * @ngdoc property
    * @name lbServices.Scanner#modelName
    * @propertyOf lbServices.Scanner
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Scanner`.
    */
...
/**
 * @ngdoc object
 * @name lbServices.RfidInfo
 * @header lbServices.RfidInfo
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `RfidInfo` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/RfidInfos/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#create
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `RfidInfo` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/RfidInfos",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#createMany
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#upsert
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#exists
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/RfidInfos/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#findById
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/RfidInfos/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#find
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#findOne
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/RfidInfos/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#updateAll
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/RfidInfos/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#deleteById
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#count
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/RfidInfos/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#prototype$updateAttributes
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#createChangeStream
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/RfidInfos/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#updateOrCreate
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#update
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#destroyById
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RfidInfo#removeById
         * @methodOf lbServices.RfidInfo
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.RfidInfo#modelName
    * @propertyOf lbServices.RfidInfo
    * @description
    * The name of the model represented by this $resource,
    * i.e. `RfidInfo`.
    */
    R.modelName = "RfidInfo";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Reagent";
        ...
        R.item = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::get::Reagent::item"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Reagent#scale
         * @methodOf lbServices.Reagent
         *
         * @description
         *
         * Fetches belongsTo relation scale.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.scale = function() {
          var TargetResource = $injector.get("Scale");
          var action = TargetResource["::get::Reagent::scale"];
          return action.apply(R, arguments);
        };
